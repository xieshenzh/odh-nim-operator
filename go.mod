module github.com/opendatahub-io/odh-nim-operator
...
replace (
	...
	github.com/kserve/kserve => github.com/kserve/kserve v0.11.1
	...
	knative.dev/networking => knative.dev/networking v0.0.0-20231115015815-3af9769712cd
	knative.dev/pkg => knative.dev/pkg v0.0.0-20231115001034-97c7258e3a98
